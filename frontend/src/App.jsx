...
function AppRoutes() {
  ...
  return (
    <Routes>
      <Route path="/login" element={isAuthenticated ? <Navigate to="/chat/new" replace /> : <LoginPage />} />
      <Route path="/signup" element={isAuthenticated ? <Navigate to="/chat/new" replace /> : <SignupPage />} />

      <Route path="/about" element={isAuthenticated ? <RequireSession><AboutPage /></RequireSession> : <AboutPage />} />
